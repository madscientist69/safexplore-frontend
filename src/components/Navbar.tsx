  ...
  return (
    <header className="sticky top-0 z-40 w-full flex justify-center pt-0">
      ...
      <div className="w-full bg-[#f15a24] text-white flex justify-center items-center relative shadow-md">
        <div className="max-w-4xl w-full flex justify-between items-center px-2 sm:px-4 md:px-8 py-1.5 sm:py-2 text-xs sm:text-sm font-semibold tracking-wide">
          ...
          <div
            ...
            className="absolute left-1/2 -translate-x-1/2 top-0 translate-y-[-2px] bg-[#0b3c61] text-white px-3 sm:px-6 py-1.5 sm:py-2.5 rounded-b-xl sm:rounded-b-2xl shadow-lg border-2 border-t-0 border-[#f15a24]/50 flex items-center gap-1.5 sm:gap-2 cursor-pointer hover:bg-[#082a44] transition-all group select-none"
          >
            <div className="w-5 h-5 sm:w-7 sm:h-7 rounded-full bg-[#00d2ff]/20 flex items-center justify-center border border-[#00d2ff]/60 group-hover:scale-105 transition-transform shrink-0">
              <ShieldAlert className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-[#00d2ff]" />
            </div>
